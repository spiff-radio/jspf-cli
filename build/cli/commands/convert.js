...
async function convertCommand(argv) {
    let { path_in = '', path_out = '', format_in = '', format_out = '', strict = false, stripInvalid = true, quiet = false } = argv;
    //Check file paths
    try {
    ...
    let dto = {};
    try {
        const result = (0, index_1.importPlaylistWithErrors)(input_data, format_in, {
    ...
    try {
        const result = (0, index_1.exportPlaylistWithErrors)(dto, format_out, {
            ignoreValidationErrors: !strict, // Default: ignore errors (show warnings), strict: abort
            stripInvalid: stripInvalid
        });
    ...
    //output
    await (0, index_2.writeFile)(path_out, output_data);
